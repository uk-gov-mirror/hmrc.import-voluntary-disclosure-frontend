...
trait IVDSubmissionTestData extends BaseMessages {
  ...
  val ivdSubmission = IVDSubmission(
    ...
    originalCpc = "4000C09",
    amendedCpc = None,
    traderContactDetails = ContactDetails("Joe Bloggs", "test@test.com", "0123456789"),
    traderAddress = ContactAddress("99 Avenue Road", "Anyold Town", Some("99JZ 1AA"), "United Kingdom"),
    defermentType = None,
